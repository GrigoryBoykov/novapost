...
"use strict";
eval("\n\nif (false) {} else {\n  module.exports = __webpack_require__(/*! ./cjs/react.development.js */ \"./node_modules/react/cjs/react.development.js\");\n}\n\n\n//# sourceURL=webpack://novapost/./node_modules/react/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var react_fast_marquee__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-fast-marquee */ \"./node_modules/react-fast-marquee/dist/index.js\");\n// import React from \"react\";\n\n\nconst burger = document.getElementById('burger');\n\n// burger\ndocument.addEventListener(\"DOMContentLoaded\", function() {\n  burger.addEventListener(\"click\", function() {\n    document.querySelector(\".header\").classList.toggle(\"open\")\n  });\n})\n\nconst header = document.querySelector('.header');\nconst shadow = document.querySelector('.shadow-wrapper');\n\ndocument.addEventListener('click', (e) => {\n  if (e.target.className === 'menu__link') {\n    header.classList.remove('open');\n    shadow.classList.remove('shadow-wrapper-open');\n  }\n});\n\nburger.addEventListener('click', () => {\n  shadow.classList.toggle('shadow-wrapper-open');\n})\n\n\n\n// slider\nconst heroSlider = new Swiper('.hero__swiper', {\n  navigation: {\n    nextEl: '.swiper-button-next',\n    prevEl: '.swiper-button-prev',\n  },\n  autoplay: {\n    delay: 4000,\n    stopOnLastSlide: false,\n    disableOnInteraction: false,\n  },\n  effect: 'fade',\n  loop: true,\n});\n\nconst workSlider = new Swiper('.work__swiper', {\n  navigation: {\n    nextEl: '.swiper-button-right',\n    prevEl: '.swiper-button-left',\n  },\n  loop: true,\n});\n\nconst teamSlider = new Swiper('.team__swiper', {\n  navigation: {\n    nextEl: '.swiper-button-after',\n    prevEl: '.swiper-button-before',\n  },\n  breakpoints: {\n    768: {\n      slidesPerView: 2,\n      spaceBetween: 20,\n    },\n    992: {\n      slidesPerView: 3,\n      spaceBetween: 20\n    },\n    1200: {\n      slidesPerView: 4,\n      spaceBetween: 20\n    },\n    1200: {\n      slidesPerView: 4,\n      spaceBetween: 30\n    }\n  },\n  loop: true,\n});\n\n\n// see more\n\n\nconst btnTextAbout = document.getElementById('btnAbout');\nconst descrBlockAbout = document.getElementById('descrAbout');\nconst btnTextSecret = document.getElementById('btnSecret');\nconst descrBlockSecret = document.getElementById('descrSecret');\n\nbtnTextAbout.addEventListener('click', () => {\n  if (descrBlockAbout.classList.contains('visible-about')) {\n    descrBlockAbout.classList.toggle('visible-about');\n    btnTextAbout.textContent = 'Показать больше';\n  } else {\n    descrBlockAbout.classList.toggle('visible-about');\n    btnTextAbout.textContent = 'Скрыть';\n  }\n})\n\nbtnTextSecret.addEventListener('click', () => {\n  if (descrBlockSecret.classList.contains('visible-secret')) {\n    descrBlockSecret.classList.toggle('visible-secret');\n    btnTextSecret.textContent = 'Показать больше';\n  } else {\n    descrBlockSecret.classList.toggle('visible-secret');\n    btnTextSecret.textContent = 'Скрыть';\n  }\n})\n\n\n// Скрывать слайдер на 768\n\nconst workSwiper = document.getElementById('workSwiper');\nconst workSwiperWrapper = document.getElementById('workSwiperWrapper');\nconst workSwiperSlider = document.querySelectorAll('.work__wrapper_slide')\n\nwindow.addEventListener('resize', () => {\n  if (window.innerWidth >= 768) {\n\n    workSwiper.classList.remove('swiper');\n    workSwiperWrapper.classList.remove('swiper-wrapper');\n\n    for (const key of workSwiperSlider) {\n      key.classList.remove('swiper-slide');\n      key.classList.add('col-md-6');\n    }\n  } else {\n\n    workSwiper.classList.add('swiper');\n    workSwiperWrapper.classList.add('swiper-wrapper');\n\n    for (const key of workSwiperSlider) {\n      key.classList.add('swiper-slide');\n      key.classList.remove('col-md-6');\n    }\n  }\n});\n\n// ticker\n\nfunction animateMarquee() {\n  const marquee = document.querySelector('.marquee');\n  const containerWidth = document.querySelector('.marquee-container').offsetWidth;\n  const contentWidth = marquee.offsetWidth;\n\n  const copiesNeeded = Math.ceil(containerWidth / contentWidth) + 1;\n  const originalContent = marquee.innerHTML;\n  marquee.innerHTML = originalContent.repeat(copiesNeeded);\n\n  let position = 0;\n  let speed = 50;\n  const duration = (contentWidth + containerWidth) / speed;\n\n  function moveMarquee() {\n      position -= speed / 60;\n      if (position < -contentWidth) {\n          position = 0;\n      }\n      marquee.style.transform = `translateX(${position}px)`;\n      requestAnimationFrame(moveMarquee);\n  }\n\n  moveMarquee();\n}\n\nwindow.addEventListener('DOMContentLoaded', (event) => {\n  animateMarquee();\n});\n\nwindow.addEventListener('resize', (event) => {\n  animateMarquee();\n});\n\n// popup\n\nconst popupLinks = document.querySelectorAll('.popup-link');\nconst body = document.querySelector('body');\nconst lockPadding = document.querySelectorAll('.lock-padding');\n\nlet unlock = true;\n\nconst timeout = 800;\n\nif (popupLinks.length > 0) {\n  for (let index = 0; index < popupLinks.length; index++) {\n    const popupLink = popupLinks[index];\n    popupLink.addEventListener('click', function (e) {\n      const popupName = popupLink.getAttribute('href').replace('#', '');\n      const currentPopup = document.getElementById(popupName);\n      popupOpen(currentPopup);\n      e.preventDefault();\n    });\n  }\n}\n\nconst popupCloseIcon = document.querySelectorAll('.close-popup');\nif (popupCloseIcon.length > 0) {\n  for (let index = 0; index < popupCloseIcon.length; index++) {\n    const el = popupCloseIcon[index];\n    el.addEventListener('click', function (e) {\n      popupClose(el.closest('.popup'));\n      e.preventDefault ();\n    });\n  }\n}\n\nfunction popupOpen(currentPopup) {\n  if (currentPopup && unlock) {\n    const popupActive = document.querySelector('.popup.open-popup');\n    if (popupActive) {\n      popupClose(popupActive, false);\n    } else {\n      bodyLock();\n    }\n    currentPopup.classList.add('open-popup');\n    currentPopup.addEventListener('click', function (e) {\n      if (!e.target.closest('.popup__content')) {\n        popupClose(e.target.closest('.popup'));\n      }\n    });\n  }\n}\n\nfunction popupClose(popupActive, doUnlock = true) {\n  if (unlock) {\n    popupActive.classList.remove('open-popup');\n    if (doUnlock) {\n      bodyUnLock();\n    }\n  }\n}\n\nfunction bodyLock() {\n  const lockPaddingValue = window.innerWidth - document.querySelector('.site-container').offsetWidth + 'px';\n\n  if (lockPadding.length > 0) {\n    for (let index = 0; index < lockPadding.length; index++) {\n      const el = lockPadding[index];\n      el.style.paddingRight = lockPaddingValue;\n    }\n  }\n\n  body.style.paddingRight = lockPaddingValue;\n  body.classList.add('lock');\n\n  unlock = false;\n  setTimeout(function () {\n    unlock = true;\n  }, timeout);\n}\n\nfunction bodyUnLock() {\n  setTimeout (function () {\n    if (lockPadding.length > 0) {\n      for (let index = 0; index < lockPadding.length; index++) {\n        const el = lockPadding[index];\n        el.style.paddingRight = 'Opx'\n      }\n    }\n\n    body.style.paddingRight = 'Opx';\n    body.classList.remove('lock');\n  }, timeout);\n\n  unlock = false;\n\n  setTimeout(function () {\n    unlock = true;\n  }, timeout);\n\n}\n\n// Полифилы\n\n(function () {\n  // проверяем поддержку\n  if (!Element.prototype.closest) {\n    // реализуем\n    Element.prototype.closest = function (css) {\n      var node = this;\n      while (node) {\n        if (node.matches (css)) return node;\n        else node = node.parentElement;\n      }\n      return null;\n    };\n  }\n})();\n\n(function () {\n  // проверяем поддержку\n  if (!Element.prototype.matches) {\n    // определяем свойство\n    Element.prototype.matches = Element.prototype.matchesSelector ||\n      Element.prototype.webkitMatchesSelector ||\n      Element.prototype.mozMatchesSelector ||\n      Element.prototype.msMatchesSelector;\n  }\n})();\n\n// Валидация форм\n\nconst form = document.querySelector('.footer__form');\nconst telSelector = form.querySelector('input[type=\"tel\"]');\nconst formPopup1 = document.querySelector('.popup__form_1')\nconst telPopup1 = formPopup1.querySelector('input[type=\"tel\"]')\nconst formPopup2 = document.querySelector('.popup__form_2')\nconst telPopup2 = formPopup2.querySelector('input[type=\"tel\"]')\nconst inputMask = new Inputmask('+7 (999) 999-99-99');\ninputMask.mask(telSelector);\ninputMask.mask(telPopup1);\ninputMask.mask(telPopup2);\n\nconst validation = new JustValidate('.footer__form',\n  {\n    errorLabelStyle: {\n      top: '54%',\n      color: '#EA3939',\n    }\n  }\n);\n\n\n\nvalidation\n  .addField('.tel-validation', [\n    {\n      rule: 'required',\n      value: true,\n      errorMessage: 'Телефон обязателен',\n    },\n    {\n      rule: 'function',\n      validator: function() {\n        const phone = telSelector.inputmask.unmaskedvalue();\n        return phone.length === 10;\n      },\n      errorMessage: 'Введите корректный телефон',\n    },\n  ]).onSuccess((event) => {\n    // console.log('Validation passes and form submitted', event);\n\n    const popupSuccess = document.getElementById('popup_2');\n\n    let formData = new FormData(event.target);\n\n    console.log(...formData);\n\n    let xhr = new XMLHttpRequest();\n\n    xhr.onreadystatechange = function () {\n      if (xhr.readyState === 4) {\n        if (xhr.status === 200) {\n          console.log('Отправлено');\n          popupSuccess.classList.add('open-popup');\n        }\n      }\n    }\n\n    xhr.open('POST', 'mail.php', true);\n    xhr.send(formData);\n\n    event.target.reset();\n\n\n  });\n\nconst validationPopup_1 = new JustValidate('.popup__form_1');\n\nvalidationPopup_1\n  .addField('.popup-validation_1', [\n    {\n      rule: 'required',\n      value: true,\n      errorMessage: 'Телефон обязателен',\n    },\n    {\n      rule: 'function',\n      validator: function() {\n        const phone = telPopup1.inputmask.unmaskedvalue();\n        return phone.length === 10;\n      },\n      errorMessage: 'Введите корректный телефон',\n    },\n  ]).onSuccess((event) => {\n    // console.log('Validation passes and form submitted', event);\n\n    const popupForm = document.getElementById('popup');\n    const popupSuccess = document.getElementById('popup_2');\n\n    let formData = new FormData(event.target);\n\n    console.log(...formData);\n\n    let xhr = new XMLHttpRequest();\n\n    xhr.onreadystatechange = function () {\n      if (xhr.readyState === 4) {\n        if (xhr.status === 200) {\n          console.log('Отправлено');\n          popupForm.classList.remove('open-popup');\n          popupSuccess.classList.add('open-popup');\n        }\n      }\n    }\n\n    xhr.open('POST', 'check-popup.php', true);\n    xhr.send(formData);\n\n    event.target.reset();\n\n\n  });\n\nconst validationPopup_2 = new JustValidate('.popup__form_2');\n\nvalidationPopup_2\n  .addField('.popup-validation_2', [\n    {\n      rule: 'required',\n      value: true,\n      errorMessage: 'Телефон обязателен',\n    },\n    {\n      rule: 'function',\n      validator: function() {\n        const phone = telPopup2.inputmask.unmaskedvalue();\n        return phone.length === 10;\n      },\n      errorMessage: 'Введите корректный телефон',\n    },\n  ]).onSuccess((event) => {\n    // console.log('Validation passes and form submitted', event);\n\n    const popupForm = document.getElementById('popup_3');\n    const popupSuccess = document.getElementById('popup_2');\n\n    let formData = new FormData(event.target);\n\n    console.log(...formData);\n\n    let xhr = new XMLHttpRequest();\n\n    xhr.onreadystatechange = function () {\n      if (xhr.readyState === 4) {\n        if (xhr.status === 200) {\n          console.log('Отправлено');\n          popupForm.classList.remove('open-popup');\n          popupSuccess.classList.add('open-popup');\n        }\n      }\n    }\n\n    xhr.open('POST', 'study-popup.php', true);\n    xhr.send(formData);\n\n    event.target.reset();\n\n\n  });\n\n\n\n//# sourceURL=webpack://novapost/./src/js/app.js?");
